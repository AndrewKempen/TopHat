...
void loop() { 
  ...
  switch(randomNumber) {
    ...
    break;
    case 2:
    colorWipe(CRGB::Black,FORWARD,MEDIUM);
    break;
    ...
    case 6:
    for(int i=0; i<2; i++){
      cylon(randomColor(), 15,FAST);
    }
    break;

    case 7:
    lightning(randomColor(),15,50,MEDIUM);
    break;
    ...
    case 9:
    for(int i=0; i<3; i++){
      theaterChase(randomColor(),8,100);
    }
    break;

    case 10:
    theaterChaseRainbow(0.5,100);
    break;
